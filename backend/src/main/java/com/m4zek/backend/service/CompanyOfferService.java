...
public class CompanyOfferService {
    ...
    public List<CompanyOfferReadModel> getAllCompanyOffers(int companyId) {
    ...
    public CompanyOfferReadModel createNewOffer(CompanyOfferWriteModel companyOfferWriteModel, int companyId) {
        Company company = getCompanyById(companyId);
        CompanyOffer newOffer = companyOfferWriteModel.toEntity(company);
